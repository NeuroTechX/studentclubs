...
--- | --- | ---
[![CRUX]({{ site.url }}{{ site.baseurl }}/images/CruX_UCLA.png "UCLA")](https://www.cruxucla.com/) | [![NEUROMADS]({{ site.url }}{{ site.baseurl }}/images/neuromads-logo.png "Pompeu Fabra University")](http://neuromads.sitemantic.com/neuromads/) | [![Your Logo Here]({{ site.url }}{{ site.baseurl }}/images/your-logo-here.png "Click to get started!")]({{ site.url }}{{ site.baseurl }}/get-started)
CruX - UCLA |  NeuroMADS - Pompeu Fabra University | Your Club Name Here
